              ...
              <FormField control={form.control} name='type' render={({ field }) => (
                <FormItem>
                  ...
                  <Select disabled={isLoading} onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                      <SelectTrigger className='border border-zinc-400 dark:border-zinc-900 focus:ring-0 text-black dark:text-white ring-offset-0 focus:ring-offset-0 capitalize outline-none'>
